...
\title{[Project code] Project Title (This the title of you project, and not the title of the chosen project topic)}% Force line breaks with \\
...
Use the bib file {\tt biblio-TIF360-FYM360.bib} (provided with this template) for the bib items.
}}
...
\begin{table*}
    ...
    \hline
        ...
        \textcolor{cyan}{Method 1}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{2.8cm}{\begin{flushleft}
        \textcolor{cyan}{Anomaly detection in sensor data}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Uses self-attention to model long dependencies. Advantage: handles variable-length sequences. Disadvantage: computationally expensive.}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Suitable for small to medium datasets with categorical or mixed features}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        \\
    \hline
        \hspace{0.1cm}
        \parbox{1.8cm}{\begin{flushleft}
        \textcolor{cyan}{Method 2}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{2.8cm}{\begin{flushleft}
        \textcolor{cyan}{Customer churn prediction} % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm} & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Simple to interpret; fast training. Advantage: no need for feature scaling. Disadvantage: prone to overfitting.}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Highly suitable for NLP and sequence modeling tasks}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        \\
    \hline
        \hspace{0.1cm}
        \parbox{1.8cm}{\begin{flushleft}
        \textcolor{cyan}{Method 3}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{2.8cm}{\begin{flushleft}
        \textcolor{cyan}{Machine translation}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}  & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Learns latent representations; captures complex distributions. Advantage: good for high-dimensional data. Disadvantage: less interpretable.}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        & 
        \hspace{0.1cm}
        \parbox{5.5cm}{\begin{flushleft}
        \textcolor{cyan}{Best for data with well-separated, roughly spherical clusters}  % Change this text accordingly
        \end{flushleft}}
        \hspace{0.1cm}
        \\
    \hline
%        \hspace{0.1cm}
%        \parbox{1.8cm}{\begin{flushleft}
%        \textcolor{cyan}{Method 4}   % Change this text accordingly
%        \end{flushleft}}
%        \hspace{0.1cm}  & 
%        \hspace{0.1cm}
%        \parbox{2.8cm}{\begin{flushleft}
%        \textcolor{cyan}{Market segmentation}   % Change this text accordingly
%        \end{flushleft}}
%         \hspace{0.1cm}  
%         & 
%         \hspace{0.1cm}
%         \parbox{5.5cm}{\begin{flushleft}
%         \textcolor{cyan}{Partitions data into clusters based on distance. Advantage: fast and scalable. Disadvantage: requires specifying number of clusters.}  % Change this text accordingly
%         \end{flushleft}}
%         \hspace{0.1cm}
%         & 
%         \hspace{0.1cm}
%         \parbox{5.5cm}{\begin{flushleft}
%         \textcolor{cyan}{Well-suited for unsupervised learning tasks with non-linear patterns.}  % Change this text accordingly
%         \end{flushleft}}
%         \hspace{0.1cm}
%         \\
%    \hline
